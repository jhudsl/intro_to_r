...
text_tbl <- data.frame(
    ...
    Use = c("Tolerates quotes or backticks if atypical", 
            ...
            "Only backticks if atypical",
            "Tolerates quotes or backticks if atypical", 
            "Only quotes as it works with character strings",
            "Only quotes tolerated in all cases",
            "Only quotes are tolerated",
            "Only backticks if atypical")
)
kbl(text_tbl) %>%
  kable_paper(full_width = F, html_font = "helvetica", font_size = "18") %>%
  ...
  row_spec(6:8, background = "lightblue") %>%
