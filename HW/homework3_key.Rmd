...
### **Getting Started**
In this assignment, we will be working with the child mortality data set, found here: https://jhudatascience.org/intro_to_r/data/mortality.csv.<br />
...
3.	Read in this the tab-delim file and call it `pop`: https://jhudatascience.org/intro_to_r/data/country_pop.txt.
