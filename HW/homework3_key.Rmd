...
### **Getting Started**
In this assignment, we will be working with the infant mortality data set, found here: https://jhudatascience.org/intro_to_r/data/infant_mortality.csv.<br />
...
```{r, dataImport}
mort = read_csv("https://jhudatascience.org/intro_to_r/data/indicatordeadkids35.csv")
mort = mort %>% 
  rename(country = X1)
```
