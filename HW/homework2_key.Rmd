...
```{r q2, message=FALSE}
key = read_tsv("https://jhudatascience.org/intro_to_r/data/Carvana_Data_Dictionary_formatted.txt")
```
...
```{r}
dict = readLines("https://jhudatascience.org/intro_to_r/data/Carvana_Data_Dictionary.txt")
dict = dict[ !dict %in% "" ]
