...
1) Get the dataset: https://jhudatascience.org/intro_to_R_class/data/kaggleCarAuction.csv.<br />
...
2) Import the "dictionary" from https://jhudatascience.org/intro_to_R_class/data/Carvana_Data_Dictionary_formatted.txt.<br />
...
3) (Optional) What would you do if the data was formatted with spaces and tabs and such, like this one: https://jhudatascience.org/intro_to_R_class/data/Carvana_Data_Dictionary.txt<br /> 
**Hint:** see the `readLines()` function.

```{r}
dict = readLines("https://jhudatascience.org/intro_to_R_class/data/Carvana_Data_Dictionary.txt")
dict = dict[ !dict %in% "" ]
