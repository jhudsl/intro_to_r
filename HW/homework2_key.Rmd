...
3) (Optional) What would you do if the data was formatted like this: http://johnmuschelli.com/intro_to_r/data/Carvana_Data_Dictionary.txt with spaces and tabs and such?  See the `readLines` function.
