...
library(tidyverse)
text_tbl <- data.frame(
  Type = c("base R and tidyverse function", "special tidyverse function", "base R"),
  Example = c("setdiff()", "stringr functions like str_replace()", "mean()" ))
kbl(text_tbl) %>%
  ...
  row_spec(3, background = "lightblue")
```
