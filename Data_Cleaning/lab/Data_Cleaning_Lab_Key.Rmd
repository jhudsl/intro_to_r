...
2.  Filter rows of bike that are NOT missing using `filter(!is.na(route))` for the `route` variable, assign this to the object `have_route.` What happens when you try using `!= "NA"`
