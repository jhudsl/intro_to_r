...
One important aspect (esp with subsetting) is that logical operations return `NA` for `NA` values.  This is a good thing. The data could be `> 2` or not, we don't know, 
