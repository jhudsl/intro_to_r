...
All assignments are due Friday, Jan 28, 2022.
...
Alternatively, all the packages used (in any way - homework, lecture, lab), are listed in [this text file](all_the_packages.txt).  If you would like to install all the packages from this file, please download that text file and run [this R script](scripts/install_all_packages.R).
...
days = list(
  c("Homework 1"),
  c("Intro", "RStudio", "Reproduciblility"),
  c("Basic_R", "Data_IO"),
  c("Subsetting_Data_in_R", "Homework 2"),
  c("Data_Summarization", "Data_Classes"), 
  c("Data_Cleaning"),
  c("Manipulating_Data_in_R", "Homework 3"),
  c("Data_Visualization"),
  c("Statistics", "Project_Guidelines"),
  c("Functions", "Project_Guidelines")
)
...
# Different for Final Project
FP = tolower(df$mod) == "project_guidelines"
df$lab[FP] = "[Instructions](https://jhudatascience.org/intro_to_r/Project_Guidelines/Project_Guidelines.html)"
df$Slides[FP] = ""
df$Code[FP] = "[Example RMD](https://jhudatascience.org/intro_to_r/ProjectExample/Final_Project_Example.Rmd), [Example HTML](https://jhudatascience.org/intro_to_r/ProjectExample/Final_Project_Example.html) "
...
knitr::kable(df, format = "html") %>% 
  ...
  group_rows("Day 5", grouped[5] + 1, grouped[6]) %>% 
  group_rows("Day 6", grouped[6] + 1, grouped[7]) %>% 
  group_rows("Day 7", grouped[7] + 1, grouped[8]) %>% 
  group_rows("Day 8", grouped[8] + 1, grouped[9]) %>% 
  group_rows("Day 9", grouped[9] + 1, nrow(df)) 
```
...
* Example about why factors are useful: [html](Examples/factor_example.html) & [Rmd](Examples/factor_example.Rmd)
