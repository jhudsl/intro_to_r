...
output:
  html_document
course_dates: 'January 9-13 and 17-20, 2023'
---
...
* Padmashri Saravanan: psarava1 at jhu.edu
...
* `r rmarkdown::metadata$course_dates` 1:30PM-4:50PM on Zoom  - **No class on January 16th for Martin Luther King, Jr. Day**.
* Zoom link will be emailed prior to the first class.
* Slack Workspace invitation will be sent directly via email.
* [CoursePlus Website](https://courseplus.jhu.edu/core/index.cfm/go/syl:syl.public.view/coid/17889/)
