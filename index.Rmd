...
Alternatively, all the packages used (in any way - homework, lecture, lab), are listed in [this text file](resources/all_the_packages.txt).  If you would like to install all the packages from this file, please download that text file and run [this R script](scripts/install_all_packages.R).
