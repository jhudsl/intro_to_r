...
The course will provide students “hands-on” training for analyzing data in the R statistical software package, a popular open-source solution for data analysis and visualization. We will covers data input/output, data management and manipulation, and constructing useful and informative graphics.
...
df$Code[hw1] = "[Data Quest](https://app.dataquest.io/m/499/introduction-to-programming-in-r)"
