...
## ---- fig.alt="Welcome!", out.width = "60%", echo = FALSE, fig.align='center'----
knitr::include_graphics("images/welcome.jpg")


## ---- fig.alt="Carrie's picture", out.width = "30%", echo = FALSE, fig.align='center'----
knitr::include_graphics("https://ca.slack-edge.com/T023TPZA8LF-U024F9G49S8-9861ddd543db-192")


## ---- fig.alt="Ava's picture", out.width = "30%", echo = FALSE, fig.align='center'----
...
## ---- fig.alt="Grant's picture", out.width = "30%", echo = FALSE, fig.align='center'----
knitr::include_graphics("https://ca.slack-edge.com/T9HRLUCSW-UHLJ37F7U-c7982c75f1d0-512")


## ---- fig.alt="Qier's picture", out.width = "30%", echo = FALSE, fig.align='center'----
...
## ---- fig.alt="R logo", out.width = "20%", echo = FALSE, fig.align='center'----
knitr::include_graphics("https://www.r-project.org/Rlogo.png")


## ---- fig.alt="R-Ladies - a non-profit civil society community", out.width = "25%", echo = FALSE, fig.align='center'----
