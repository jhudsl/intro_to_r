...
<!-- # Todo 
- add image of sandwich to first lab page
- correct import of data in the lab 
- restart and remove excess packages -->
...
```{r full_join}
fj <- full_join(data_As, rbind(data_cold, data_cold))
```
...
duplicated(1:5)
duplicated(c(1:5, 1))
fj %>% mutate(dup_State = duplicated(State))
```
