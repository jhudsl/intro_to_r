...
1.  Read in the Wide Bike lanes data: http://jhudatascience.org/intro_to_R_class/data/Bike_Lanes_Wide.csv .  Name the data set `wide`. Note the `NA`s here!

```{r}
wide = read_csv("http://jhudatascience.org/intro_to_R_class/data/Bike_Lanes_Wide.csv")
```
...
`crash`: http://jhudatascience.org/intro_to_R_class/Manipulating_Data_in_R/lab/crashes.csv
`road`: http://jhudatascience.org/intro_to_R_class/Manipulating_Data_in_R/lab/roads.csv
