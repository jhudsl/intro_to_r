...
2. Homework 2 Problem Set: 
   - [Questions (Rmd)](https://jhudatascience.org/intro_to_R_class/HW/homework2.Rmd), [Questions (HTML)](https://jhudatascience.org/intro_to_R_class/HW/homework2.html)         
   - [Key (Rmd)](https://jhudatascience.org/intro_to_R_class/HW/homework2_key.Rmd), [Key (HTML)](https://jhudatascience.org/intro_to_R_class/HW/homework2_key.html)
3. Homework 3 Problem Set:
   - [Questions (Rmd)](https://jhudatascience.org/intro_to_R_class/HW/homework3.Rmd), [Questions (HTML)](https://jhudatascience.org/intro_to_R_class/HW/homework3.html)         
   - [Key (Rmd)](https://jhudatascience.org/intro_to_R_class/HW/homework3_key.Rmd), [Key (HTML)](https://jhudatascience.org/intro_to_R_class/HW/homework3_key.html)
