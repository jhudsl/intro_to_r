...
5. Which bike lane`type` has (a) the most number of and (b) longest average bike lane length? (Hint: `group_by` and `summarize`)
...
6. Take your code from the above question, adding another pipe (`%>%`) and `arrange()` to sort the output by `mean`.
