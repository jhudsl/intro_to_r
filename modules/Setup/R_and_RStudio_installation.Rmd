...
-   For Mac users (M1 chip): <https://cloud.r-project.org/bin/macosx/big-sur-arm64/base/R-4.2.2-arm64.pkg>

-   For Mac users (Intel chip): <https://cloud.r-project.org/bin/macosx/base/R-4.2.2.pkg>

-   For Windows users: <https://cloud.r-project.org/bin/windows/base/R-4.2.2-win.exe>
