...
We recommend installing the most recent version or `R` (4.2.2 as of October 31, 2022). **If you have had installed `R` already some time ago, we recommend updating/reinstalling it to the most recent version.** Use a link below to launch download of `R` installers (if the download does not start, a fix may be to copy-paste the below link to your browser):

-   [Download For Mac users (M1 chip)](https://cloud.r-project.org/bin/macosx/big-sur-arm64/base/R-4.2.2-arm64.pkg)

-   [Download For Mac users (Intel chip)](https://cloud.r-project.org/bin/macosx/base/R-4.2.2.pkg)

-   [Download For Windows users](https://cloud.r-project.org/bin/windows/base/R-4.2.2-win.exe)
