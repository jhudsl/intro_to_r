...
1. Please submit your filled out `.Rmd` file to the assignment drop box on CoursePlus: (`r config::get("courseplus_dropboxes")`)

2. All assignments are due by `r config::get("final_due_date")`. Please reach out to us if you need help before this time!
