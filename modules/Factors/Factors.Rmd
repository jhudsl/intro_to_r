...
R does not realize that there is any order related to the `grade` values. It will assume that it is **alphanumeric**. 
...
📃[Day 6 Cheatsheet](https://jhudatascience.org/intro_to_r//modules/cheatsheets/Day-7.pdf) 
