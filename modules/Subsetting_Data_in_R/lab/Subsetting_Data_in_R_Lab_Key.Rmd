...
1. Create a subset called `countysub`from the `county_pop`  that only contains the columns:
`county_name`,	`state_name`, `population`, and for only the rows with the year 2012 (`year`).
