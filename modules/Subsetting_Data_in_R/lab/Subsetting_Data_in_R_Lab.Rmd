...
Next, rename the column `BUYER_STATE`  to be `State_name` (hint - use `rename()` and watch out for the order of the new and old names!). Reassign this object as `county_pop`.
...
Select the variables that contain the letter "a" from `county_pop`.
