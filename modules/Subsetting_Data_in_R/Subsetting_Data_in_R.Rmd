...
It's best to avoid unusual column names where possible.
...
- other punctuation marks besides "_"


<!-- ## Unusal Comun Names -->

<!-- These are the conventions, most options will work for most functions. -->
<!-- Sometimes you need to just try and check your work! \` backticks\` vs "quotes" or 'quotes' -->


<!-- <!-- | Example 	| Type	| Use 	| --> -->
<!-- <!-- |:---:|:---:|:---:| --> -->
<!-- <!-- |Liver| character string - word | use quotes ('single' or "double")| --> -->
<!-- <!-- |New York| character string - phrase | use quotes ('single' or "double")| --> -->
<!-- <!-- | col 1 | atypical - has spaces and numbers | use \` backticks\`  | --> -->
<!-- <!-- | col.1	| atypical - has punctuation (besides "_")	| use \` backticks\`  |  --> -->
<!-- <!-- | 1	| atypical - just a number	| use \`backticks\` | --> -->
<!-- <!-- | 1st col	| atypical - start with number 	| use \` backticks\`  |"  --> -->

<!-- ```{r echo=FALSE, message=FALSE, warning=FALSE} -->
<!-- library(kableExtra) -->
<!-- text_tbl <- data.frame( -->
<!--     Type = c("character string",  "atypical", "atypical", "atypical"), -->
<!--   Example = c("New York", "col.1", "1", "1st col"), -->
<!--   Features = c("spaces",  "has punctuation ", "just a number", "starts with number"), -->
<!--  Use = c("use quotes - single or double", "use `backticks`", "use `backticks`", "use `backticks`") -->
<!-- ) -->
...
<!--   row_spec(2:4, background = "lightgreen") -->
<!-- ``` -->
<!-- You will see this come up again when we refer to row values too. We will need quotes for character strings even if it is a single word or letter.  -->
...
- if you must do a nonstandard column name, use backticks to refer to it
...
```{r, eval = FALSE}
filter(iris, "Species" == "virginica") # this will give an error
```

## Be careful with column names and `filter`

```{r}
filter(iris, Species == "virginica") # this works!
```

## `filter()` is tricky

Try not use anything special for the column names in `filter()`
