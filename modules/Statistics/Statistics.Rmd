...
::: {style="color: red;"}
⚠️ We will focus on how to use R software to do these. We will be glossing over the statistical theory and "formulas" for these tests. Moreover, we do not claim the data we use for demonstration meet assumptions of the methods. ⚠️ 
:::
...
⚠️ You run an increased risk of Type I errors (a "false positive") when multiple hypotheses are tested simultaneously.
...
data(oswego)
ice_cream <-
  oswego %>% select(ill, vanilla.ice.cream) %>% mutate(
