...
The correlation coefficient is a summary statistic that measures the strength of a linear relationship between two variables.
...
x <- circ %>% pull(orangeAverage)
y <- circ %>% pull(purpleAverage)
sum(is.na(x)); sum(is.na(y)) # count NAs in x and y
t.test(x, y)
```
