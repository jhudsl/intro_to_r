...
RStudio is also a company that is now called [Posit](https://posit.co/).
...
## Getting the editor
You must open a to save code to open the editor. These include for example R Scripts or R Markdown.
...
To make an R Markdown file:  click the green plus button -> R Markdown. We will do this together soon! 
...
<font size="5"> https://jhudatascience.org/intro_to_r/modules/RStudio/lab/RStudio_Lab.Rmd </font>
...
2)  Select R (default) as the language:
