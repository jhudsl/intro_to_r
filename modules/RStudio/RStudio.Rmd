...
```{r, fig.alt="RStudio layout", out.width = "70%", echo = FALSE, fig.align='center'}
...
```{r, fig.alt="knit", out.width = "70%", echo = FALSE, fig.align='center'}
...
```{r, fig.alt="preview a function", out.width = "70%", echo = FALSE, fig.align='center'}
...
```{r, fig.alt="help_pane", out.width = "80%", echo = FALSE, fig.align='center'}
...
```{r, fig.alt="getting help", out.width = "80%", echo = FALSE, fig.align='center'}
...
```{r echo=FALSE, fig.align='center', out.width="70%"}
knitr::include_graphics("images/colorfulHeader.png")
```
