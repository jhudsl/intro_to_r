...
4. Now install a package that the instructors made that is not on CRAN but on GitHub, by copy and pasting the code into the console:
...
5. Press the green play button. What happens (check the environment too!)?
...
6. Try the "run all chunks above" button that is to the left of the play button on the following chunk. What happens?

7. Then press the play button on this same chunk. What happens?
...
8. Add a new R chunk after `<!-- Your code chunk goes here -->`. You can use the insert chunk button or copy paste an existing code chunk. Include a lowercase x inside the chunk as the code. Make sure you press the knit button after this to see what the new chunk looks like. 
