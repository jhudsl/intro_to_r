...
1. Update the options of the R chunk you just made (with the lowercase x in it) so that the output option is `show output only`. How does the chunk look now?
2. Create another R Markdown Document from RStudio dropdowns: File → New File → R Markdown.
