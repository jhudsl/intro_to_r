...
This is a code chunk that will set up our packages and data (this will not show up in the rendered report when we press knit):
...
Next we will show you some code - no worries about understanding it yet, we just want to get you familiar with where code goes. When it is in an RMarkdown file chunk it is code that is saved to a file. When it is in the console, it is not saved. The console is useful for installing packages as we saw.
