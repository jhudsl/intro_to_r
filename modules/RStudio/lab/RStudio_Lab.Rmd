...
3. Update the options of the R chunk you just made so that the output option is `show output only`. How does the chunk look now?

Bonus:
1. Change the days you are keeping to show `"Sunday"` instead of `"Saturday"`.
2. Create another RMarkdown Document from RStudio dropdowns: File → New File → R Markdown.
