...
The console is useful for installing packages like we just did, this is because sometimes we have to interact with R directly and answer questions. Another reason that it is a good idea to install packages in the console is we only need to do it once, so we don't usually need to save the code.
