...
For numeric: `seq()` can be very useful- both integar and double.   
...
## Creating numberic vectors `sample()`
...
- as.CLASS_NAME(x) cab be used to change the class of an object x
