...
Copy your code from problem 3 and modify it to write to the data directory inside your R Project. *Note: you may need to make a new folder named "data" if it doesn't already exist.*
...
Write one of the variables in your Environment to your working directory in `rds` format. Call the file `my_variable.rds`.
