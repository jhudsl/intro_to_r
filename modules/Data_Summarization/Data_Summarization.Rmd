...
<!-- Instructor note: You can also use `n_distinct()` from the dplyr package. This is faster and perhaps somewhat more intuitive: -->
<!-- mtcars %>% dplyr::n_distinct("mpg", "cyl") -->
...
`count()`, `table()`, and `n()` can all give very similar information.
