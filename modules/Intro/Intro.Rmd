...
<!-- 1. I don't know anything and I'm very nervous. -->

<!-- 2. I'm very excited about the course and to learn everything I can about R. -->

<!-- 3. I already know some R, but I want to learn more. -->
...
```{r, fig.alt="Sabit's picture", out.width = "25%", echo = FALSE, fig.align='center'}
...
knitr::include_graphics("https://github.com/rladies/branding-materials/blob/main/logos/horizontal/RLadies%2B%20logo_Horizontal-Full%20colour.svg")
```
...
```{r, fig.alt="Intro to R course logo", out.width = "40%", echo = FALSE, fig.align='center'}
