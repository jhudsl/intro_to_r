...
Download the dataset of asthma prevalence in the USA from: http://jhudatascience.org/intro_to_r/data/asthma.xlsx file to `asthma.xlsx` by running the following code chunk. This only downloads the file, it does NOT bring the file into R.
...
By default, R reads the first sheet of an excel file. Copy your code from question 9 and add the following argument: `sheet = 2`. Inspect the data using `head()`.
