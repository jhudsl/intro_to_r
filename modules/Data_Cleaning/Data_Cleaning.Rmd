...
::: {style="color: red;"}
⚠️ THINK ABOUT YOUR DATA FIRST! ⚠️
:::
...
::: {style="color: red;"}
⚠️ You might want to keep the `NA` values so that you know the original
sample size. ⚠️
:::
...
::: {style="color: red;"}
⚠️ Calculating percentages will give you a different result depending on
your choice to include NA values.! ⚠️
:::
