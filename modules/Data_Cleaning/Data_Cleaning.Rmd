...
`r emoji("warning")` Is an `NA` for values so low they could not be reported? 

`r emoji("warning")` Or is it if it was too low and also if there was a different issue (like no one reported)?
