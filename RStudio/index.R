...
## ---- fig.alt="RStudio logo", out.width = "30%", echo = FALSE, fig.align='center'----
...
## ---- fig.alt="RStudio", out.width = "65%", echo = FALSE, fig.align='center'----
knitr::include_graphics("images/rstudio_sheet.png")


## ---- fig.alt="Picture of R package stickers", out.width = "30%", echo = FALSE, fig.align='center'----
knitr::include_graphics("../images/hex.png")


## ---- fig.alt="Picture of Hadley Wickham", out.width = "20%", echo = FALSE, fig.align='center'----
...
## ---- fig.alt="knit", out.width = "100%", echo = FALSE, fig.align='center'----
knitr::include_graphics("images/knit.png")


## ---- out.width = "40%", echo = FALSE, fig.align='center'---------------------
knitr::include_graphics("images/RMarkdown.png")


## ---- fig.alt="RStudio layout", out.width = "100%", echo = FALSE, fig.align='center'----
