...
**CoursePlus:** https://courseplus.jhu.edu/core/index.cfm/go/syl:syl.public.view/coid/17889/

**Zoom link will be emailed to students.**

**Day/Time:** January 9 - 20: 1:30PM-4:50PM ET on Zoom (**No class on January 16th for Martin Luther King, Jr. Day**.)

**Instructors:** Carrie Wright (cwrigh60@jhu.edu), Ava Hoffman (ava.hoffman@jhu.edu)

**Teaching Assistants:** Padmashri Saravanan (psarava1@jhu.edu)
...
All assignments are due Monday, January 25th, 2022 at 11:59pm EST. Note that we must submit final grades by January 27th, so please turn in your assignments before this date so that we can give you credit for your efforts.
...
Submit each assignment to the designated [Drop Box on CoursePlus](https://courseplus.jhu.edu/core/index.cfm/go/db:main/coID/17889/).
...
For example, if you scored 9/10 on an assignment (90%) but turned it in two days late, your score would be 8.6/10 (86%). Note that we must submit final grades by January 27th, so please turn in your assignments before this date, so that we can give you credit. 
