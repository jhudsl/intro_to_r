...
All assignments are due `r config::get("final_due_date")`. Note that we must submit final grades by `r config::get("grades_due")`, so please turn in your assignments before this date so that we can give you credit for your efforts.
