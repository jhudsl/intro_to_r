...
Example projects can be found with the source code: [Rmd](modules/Project_Example/index.Rmd), and the output [html](modules/Project_Example/Project_Example.html) here.
