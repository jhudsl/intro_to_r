...
Example projects can be found with the source code: [Rmd](modules/Project_Example/index.Rmd), and the output [html](modules/Project_Example/index.html) here.

See the [guidelines/instructions](modules/Project_Guidelines/index.html) for final projects.
