...
* Part 1: reading CSV file, checking for problems in the loaded data, data input overview, common new user mistakes in data reading
* Part 2: working directories, relative vs. absolute paths, reading XLSX file (Excel file), other data inputs
...
* Open Baltimore Data and Data.gov will be sources for the first few days
...
There is another convenient function for reading in CSV files, where the delimiter is assumed to be a comma (`readr::read_csv`): 
