...
Let's try this out on the childhood mortality data used above. However, let's do some manipulation first, by using `pivor_longer` on the data to convert to long. 
...
[Website](https://jhudatascience.org/intro_to_r/index.html)
...
<!-- We can do histograms again using `hist`.  Let's do histograms of mort rates over the years: -->

<!-- ```{r hist_mort, comment="", fig.align='center', cache=FALSE} -->
<!-- hist(sub$morts, breaks = 200) -->
<!-- ``` -->

## Histograms again: Changing bins
 
```{r qhist_mort, comment="", fig.align='center', cache=FALSE}
...
```{r gdens_line_alpha_mort, comment="", fig.align='center', cache = FALSE}
...
# ggplot examples on a second dataset
