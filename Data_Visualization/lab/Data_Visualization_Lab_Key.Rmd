...
```{r}
plot(x = bike_agg$dateInstalled, y = bike_agg$lane_count)
plot(x = bike_agg$dateInstalled, y = bike_agg$lane_count, type = "l")
...
```{r}
ggplot(bike_agg, aes(x = dateInstalled, y = lane_count)) + 
  geom_line() + 
  geom_point()
