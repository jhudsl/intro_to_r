...
1. The student described **where** the data came from including how the instructor could access the data. (0.5 / 0.5 points)
2. The student described information about the data (what the variables mean) and how the data was originally created. (0.5 / 0.5 points)
...
4. The student described what steps they did to wrangle the data and why.  (0.5/ 0.5 points)
