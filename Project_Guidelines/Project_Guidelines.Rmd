...
(1 points total - 0.5 points for describing data, 0.5 points for describing where you got your data)
...
(2 points total: 1 points if at least an attempt; 1 point for each of 2 **different** kinds of plots completed)
...
8) Add `sessionInfo()` to the end of your analysis so that you and others can see what version of R and packages you used. (0.5 points)
