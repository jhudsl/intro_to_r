...
Here are a few changes that will show you how to change small things in `R` code and the output it makes.  After each change, hit the **Knit** button again.s

1.  Go through and change the colors in `palette` to something other than what they originally were.  
