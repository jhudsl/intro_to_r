...
- **Optional** - Some TAs have helped teach a lecture (using our materials, although updates are possible but we would need to discuss). (There is no expectation for this, but some TAs like the opportunity to practice their lecturing skills.)
- **Optional** - Some TAs have also helped us make updates to material on GitHub (using a Pull Request). (There is no expectation this, but some TAs like the opportunity to practice their GitHub skills.)
